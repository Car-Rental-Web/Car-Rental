        ...
        <div className="overflow-x-auto">
          <table className=" w-full table-auto text-left min-w-[1200px]">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="w-16 p-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest text-center">
                  ID
                </th>
            ...
            <tbody className="divide-y divide-slate-100">
              {currentItems.map((row, index) => (
                ...
                >
                  ...
                  <td className="p-4 text-center text-xs text-slate-600 truncate">
                    {row.address || "N/A"}
                  </td>
            ...
            <table className="w-full text-left">
              <thead className="bg-slate-800 text-white">
                <tr>
                  ...
                  <th className="p-4 text-[10px] uppercase font-black text-center">
                    Status
                  </th>
                </tr>
              </thead>
